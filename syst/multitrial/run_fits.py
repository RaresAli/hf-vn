...
def main():
    ...
    parser.add_argument('reference_dir', help='Directory containing reference files')  # non più usato per cutsets
    ...
    for yaml_file in args.yaml_files:
        ...
        # Usiamo lo stesso yaml_file come cutset (non abbiamo cutset separati)
        for pf in proj_files:
            all_tasks.append((yaml_file, yaml_file, pf))   # passiamo lo stesso per cutset

    if not all_tasks:
        print("Nessun task da eseguire. Verifica che le directory projs esistano.")
        return
